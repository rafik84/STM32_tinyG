...
#define TIMER_DDA2			TCC0		// DDA timer 	(see stepper.h)
#define TIMER_DWELL2	 		TCD0		// Dwell timer	(see stepper.h)
#define TIMER_LOAD2			TCE0		// Loader timer	(see stepper.h)
#define TIMER_EXEC2			TCF0		// Exec timer	(see stepper.h)
